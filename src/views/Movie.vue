                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item pb-3 pt-3" v-for="review in movie.reviews" :key="review._id">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">{{ getFormattedDate(review.date) }}
                            </h6>
                            ...
                            <a v-if="verifyAuthorship(review.user_id)" v-on:click="editReview(review)"
                                class="btn btn-primary me-3">
                                Edit
                            </a>
                            <a v-if="verifyAuthorship(review.user_id)" v-on:click="deleteReview(review._id)"
